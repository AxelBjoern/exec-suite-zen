...
function applyDriver(a: Assumptions, key: DriverKey, factor: number): Assumptions {
  ...
  switch (key) {
    case "pricePerKwh": mut((y) => { y.pricePerKwh *= factor; }); break;
    case "costPerKwh": mut((y) => { y.costPerKwh *= factor; }); break;
    ...
    case "kwhPerCustomer": mut((y) => { y.kwhPerCustomerYear *= factor; }); break;
